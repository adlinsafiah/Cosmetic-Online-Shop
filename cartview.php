...
if(isset($_POST['check'])){
  ...
  $psw=$_POST["psw"];
	...
	$check="SELECT * FROM user WHERE email = '$email' AND psw = '$psw'";
	...
	if(!$query){
		echo "<script type='text/javascript'>alert('Incorrect password! Please send an inquiry if you forgot your password');</script>";
		header("refresh:0, url = cartview.php");
	}
}
?>
  ...
  <h2>Kathaleia&#9829;</h2>
	...
	<table cellpadding="10px" align="center">
        ...
        <form method="post">
				...
				<td><button class="button"><a href="delete.php?m=<?php echo $row['product_id'];?>">Delete</a></button></td>
		</tr>
	<?php $count++;}?>
		<tr>
			<td colspan="5" align="right">
				<p style="font-size: 24px;">Total Amount : RM <?php echo number_format($amount,2,'.','');?></p>
			</td>
      <td></td>
		</tr>
    <tr>
      <td colspan="5" align="right">Are you a member? <a href="signin.php"> Click Here </a></td>
      <td></td>
		<tr>
			<td colspan="6" align="right">
				<button class="button"><a href="paymentform.php?p=<?php echo $amount;?>">Check Out</a></button>
			</td>
		</tr>
	</table>
	<footer>
